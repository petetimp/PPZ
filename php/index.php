    ...
    <body>
    	<div id="pageContainer">
            <header>
              ...
              <h1 id="slogan">Get in the Zone--Paul's Pet Zone<span id="registered">&reg;</span></h1>
              ...
              <div id="tri2" class="triangle-r"></div> <!-- Right triangle -->
                ...
                <nav id="mainMenu">
                    <li class="menuItem"><a class="menuLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=home">Home</a></li>
                    <li class="menuItem"><a class="menuLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=about#about">About Us</a></li>
                    <li class="menuItem"><a class="menuLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=location#location">Store Location</a></li>
                    <li class="menuItem"><a class="menuLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=grooming#grooming">Grooming</a></li>
                    <li class="menuItem"><a class="menuLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=contact#contact">Contact Us</a></li>
                </nav>
            ...
            <footer>
              	...
              	<div class="footLinks">
                    ...
                    <a class="footLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=hours#hours">Hours of Operation</a> |
                    <a class="footLink" href="http://paulspetzone-ppz.rhcloud.com/index.php?page=Internships#internships">Internships</a> |
        	...
        	<div id="blackBg">
            	<div id="copyright">
                	<p>
                		&copy; Paul's Pet Zone 20<?php echo date('y') ?>. 
                    	All rights reserved<br/>
                        <strong>DISCLAIMER:</strong> This is not a real site and is intended for academic/viewing purposes only.
    	        	</p>
    			</div>
            </div>
        </div>
